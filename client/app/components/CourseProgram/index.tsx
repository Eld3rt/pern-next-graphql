...
const CourseProgram: React.FC<Props> = ({ course }) => {
  ...
  const shouldShowTopicsList = course.topics.length > 1
      ...
      <div className="course-program__inner custom-container">
        ...
        <div className="course-program__content text-gray-800 bg-white rounded-lg overflow-hidden border border-green-100">
          ...
          {shouldShowTopicsList ? (
                ...
                <li key={topic.id} className="course-program__topic px-4 py-4">
                  ...
                  >
                    {topic.lessons.map(lesson => (
                      <li
                        key={lesson.id}
                        className="course-program__lesson flex justify-between items-center px-4 py-4"
                      >
            ...
            <ul className="course-program__lessons divide-y divide-green-100 text-gray-800">
              {course.topics[0].lessons.map(lesson => (
