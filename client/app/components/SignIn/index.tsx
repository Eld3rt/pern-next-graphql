...
const SignInCard: React.FC<SignInCardProps> = ({ startTransition }) => {
  ...
  return (
    <div className="sign-in-card bg-white w-full max-w-5xl rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2 lg:p-10">
      ...
      <div className="sign-in-card__image hidden md:block">
        <img
          src="https://lh3.googleusercontent.com/pw/AP1GczOkr_tdvbxLv153SafDRIQ0shk3I36n8t_Bw0l-8eeaPO_mhljDjsmpe_tvYIEngCRuoHAq0_-wgEKi7PVlOktn4HQ2PbFCxT3EE83VUT37koV4o8SP6Blfpf5xwcIWSuvWMWro43eDf7V8WZ3ey5bR=w945-h945-s-no-gm"
          alt="Sign in image"
...
const SignIn: React.FC<SignInProps> = () => {
  ...
  return (
    <section className="sign-in min-h-screen flex items-center justify-center p-4">
      ...
      <Suspense>
        <SignInCard startTransition={startTransition} />
      </Suspense>
    </section>
  )
}
