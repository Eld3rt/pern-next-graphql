...
const SignUpCard: React.FC<SignUpCardProps> = ({ startTransition }) => {
  ...
  return (
    <div className="sign-up-card bg-white w-full max-w-5xl rounded-3xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-2 lg:p-10">
      ...
      <div className="sign-up-card__image hidden md:block">
        <img
          src="https://lh3.googleusercontent.com/pw/AP1GczNzD8KUTc497c4k5_QL8eL13ySlKX6q77AM1fXSCTwTeFg5Gn2V6IXxoE7hOI1nUau8Cqf4AzzbQ3VDGO7ga9Q1-TBRHhw8HHD8OP9pPyFbJ8Qfa1y6LKoFTlPd5s979mbNG5uSSyQNgFMzUaz2O5GA=w945-h945-s-no-gm"
          alt="Sign up image"
...
const SignUp: React.FC<SignUpProps> = () => {
  ...
  return (
    <section className="sign-up min-h-screen flex items-center justify-center p-4">
      ...
      <Suspense>
        <SignUpCard startTransition={startTransition} />
      </Suspense>
    </section>
  )
}
